...
ggplot(diamonds, aes(x = carat, y = price) , str(diamonds)) + geom_point() + geom_smooth()
...
dia_plot <- dia_plot + geom_smooth(aes(colour = clarity), se = FALSE)
...
# Map cyl to size
ggplot(mtcars, aes(x = wt, y = mpg, fill = cyl, size = cyl)) +
  geom_point()



# Map cyl to alpha
ggplot(mtcars, aes(x = wt, y = mpg, fill = cyl,alpha = cyl)) +
  geom_point()


# Map cyl to shape 
ggplot(mtcars, aes(x = wt, y = mpg, fill = cyl,shape = cyl)) +
  geom_point()
